...
public class Jeu{ // Définition de la classe
	...
	public Jeu(Fenetre f, boolean classe){
		...
		player1 = new Joueur(new Point((Constantes.TAILLEX/2),0));	
		player1.add(fen);
		...
		//Si partie classée (en ligne)
		if(classe)
		{
			String Meilleurscore = MultiBox.client.getTopScore();
			Texte aff_m_score=new Texte(Couleur.BLEU,("Top score : "),policeDuJeu,new Point(70,(Constantes.TAILLEY-20)));
			Texte aff_m_score_2 = new Texte(Couleur.BLEU,(Meilleurscore),policeDuJeu,new Point(80,(Constantes.TAILLEY-40)));
			fen.ajouter(aff_m_score);
			fen.ajouter(aff_m_score_2);
			fen.rafraichir();
		}
	...
	public void GenererEnnemi(){
		...
		fen.rafraichir();	
		random_position = (int)(Math.random()*(6-1))+1; // Pour générer sa position dans la voie de circulation
